...
local rsAddresses = component.list('redstone')
local rs = component.proxy('3a1a1e1a-b13a-4f87-898b-acda1bb1e513')
local rsOut = component.proxy('d55f21ae-5c3b-4740-8498-c75197b90742')

local rsCount = 0
for k,v in pairs(rsAddresses) do
  rsCount = rsCount + 1
  if (rsCount == 1) then
    rs = component.proxy(k)
  end
  if (rsCount == 2) then
    rsOut = component.proxy(k)
  end
end
